...
LIBNAME = "libcrustabri_ipafair.so"
LIBPATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../target/release/', LIBNAME)

semantics_to_code = {"AD": 0, "CO": 1, "PR": 2, "ST": 3, "SST": 4, "STG": 5}

class Crustabri(ipafair.AFSolver):
    def __init__(self, sigma: str, af_file: str = None):
        ...
        self.solver = self.lib.ipafair_init_dummy()
